export default [
    {
        ...
        tools: ["Bones", "Shroud", "Today’s obituary column", "Ouija board (the mage must use the planchette during casting)"]
    },
    {
        name: "Fate",
        icon: '🎲',
