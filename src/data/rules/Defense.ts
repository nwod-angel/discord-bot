export default {
    ...
    paragraphs: [
        ...
        {
            example: true, text: "Sims finds himself in a barroom brawl with three bikers. His Dexterity is 4 and his Wits is 2. Taking the lower of the two Attributes, his Defense trait is 2. As the bikers wade in Sims does his best to avoid their swings."
        },
        "The first biker suffers a -2 modifier to his attack roll — Sims’ full Defense — while the second biker incurs only a -1 modifier. The third attacker is unaffected, as Sims has no Defense left to avoid the assailant’s punch.",
        "Defense is not affected by any wound penalties (p. 171) that your character may have incurred.",
