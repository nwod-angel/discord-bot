...
export default {
    ...
    paragraphs: [
        ...
        new RuleParagraph({
            example: true, text: "If in the next turn Drew still has a hold on Anderson, a Strength + Brawl roll, penalized by Anderson’s Strength, is made to see if Drew can perform any maneuvers on Anderson." + "\n" +
